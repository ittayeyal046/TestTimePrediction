...
PartType = parametersAsDictionary['PartType']#"H64ADNSVAL"
ProcessStep = parametersAsDictionary['ProcessStep']#'CLASSCOLD'
ExperimentType = parametersAsDictionary['ExperimentType']#'Engineering'
